...
<html>
  <head>
	...
	<!--Quiz-->
	<link href="../dist/quiz/css/slickQuiz.css" media="screen" rel="stylesheet" type="text/css">
	<link href="../dist/quiz/css/master.css" media="screen" rel="stylesheet" type="text/css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
							...
							<div class="box-body">						
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div id="slickQuiz">
											<h1 class="quizName">Prova de Avaliação Técnica</h1>
											<div class="quizArea">
												<div class="quizHeader">
													<a class="button startQuiz" href="#">Iniciar Avaliação Técnica</a>
												</div>
											</div>
											<div class="quizResults">
												<h3 class="quizScore">Você acertou: <span><!-- where the quiz score goes --></span></h3>
												<h3 class="quizLevel"><strong>Percentual de acertividade: </strong> <span><!-- where the quiz ranking level goes --></span></h3>
												<div class="quizResultsCopy">
													<!-- where the quiz result copy goes -->
												</div>
												
												</br>
												<a href="../candidates/home.php">
	...
	<!--Quiz-->
	<script src="../dist/quiz/js/slickQuiz-config.js"></script>
	<script src="../dist/quiz/js/slickQuiz.js"></script>
	<script src="../dist/quiz/js/master.js"></script>
