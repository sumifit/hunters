...
if ($logado == true) {
    ...
    <head>
        ...
        <script>
            hunters.controller('homeController', ['FormUtils', '$scope', '$http', 'configs', 'alertify', function (FormUtils, $scope, $http, configs, alertify) {

            }])
        </script>
    </head>
    <body class="hold-transition skin-blue sidebar-mini" ng-controller="homeController">
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><i class="fa fa-edit"></i>Perfil</li>
                    </a>
                    </li>
                    <li>
                        <a href="../candidates/calendar.php">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2016-<?php echo date('Y'); ?> <a href="http://www.sumifit.com/"> SumIFIT </a></strong> All rights
            reserved.
        </footer>
    ...
    <script src="../dist/js/pages/pagecontrol.js"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            changepage("<?php echo $_SESSION["page"]?>");
        });
    </script>
    <!-- jQuery UI 1.11.4 -->
    ...
    echo "<h3>Voce não tem permissão para visualizar essa pagina, redirecionando para tela de login. </h3>";
