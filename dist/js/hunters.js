 ...
 */
var hunters = angular.module('hunters', ['angularPromiseButtons', 'angular-loading-bar', 'directive.g+signin', 'ngAlertify']);
...
hunters.run(function ($rootScope, $http, configs) {
    ...
    //pega os dados da caixa de entrada

    //pega os dados da avaliação técnica
});
